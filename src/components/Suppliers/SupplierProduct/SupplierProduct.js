...
const SupplierProductPage = () => {
  ...
  const [product, setProduct] = useState({
    ...
    brandName: "",
    supplierId: supplierId, // Replace with the initial value or leave it as null
    supplierName: "",
    description: "",
  ...
  const [showAttributeCreateModal, setShowAttributeCreateModal] =
    useState(false);
  ...
  // search supplier's product via id
  ...
  const handleCreateProductAttribute = async () => {
    ...
    try {
      await axios.post(
        `${process.env.REACT_APP_API_URL}/api/v1/productAttributes`,
        productAttribute
      );
            ...
            <tr key={product.productId}>
              ...
              <td className="attributes-column">
                ...
                <button
                  ...
                  onClick={() =>
                    handleShowCreateProductAttributesModal(product)
                  }
                >
                  Add
                </button>
